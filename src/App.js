...
class App extends Component {
  ...
  render() { 
    return ( <div className="card">
     ...
     <input type='text' placeholder='Card number'maxlength="20" onChange={(e)=>this.addNumber(e)}/><br/>
     <input type='text' placeholder='date'maxlength="5" onChange={(e)=>this.addDate(e)}/><br/>
     <div>
